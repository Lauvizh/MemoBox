 ...
 * @ORM\Entity(repositoryClass="LF\MediasBundle\Repository\MediaRepository")
 */
class Media
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="LF\EventBundle\Entity\Event", inversedBy="medias")
    ...
    /**
     * @ORM\OneToMany(targetEntity="LF\FaceBundle\Entity\FacePlace", mappedBy="media", cascade={"persist"})
     * @ORM\JoinColumn(nullable=true)
     */
    private $facePlaces;

    /**
     * @ORM\OneToMany(targetEntity="LF\MediasBundle\Entity\Comment", mappedBy="media", cascade={"persist"})
     * @ORM\JoinColumn(nullable=true)
     */
    private $comments;
     ...
     * Add comment
     *
     * @param \LF\MediasBundle\Entity\Comment $comment
     *
     * @return Media
     */
    public function addComment(\LF\MediasBundle\Entity\Comment $comment)
    {
     ...
     * @param \LF\MediasBundle\Entity\Comment $comment
     */
    public function removeComment(\LF\MediasBundle\Entity\Comment $comment)
    {
